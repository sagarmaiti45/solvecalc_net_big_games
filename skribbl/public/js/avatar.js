...
const my = {
    ...
    avatar: localStorage.getItem('avatar') || 'https://api.dicebear.com/7.x/avataaars/svg?seed=default',
};
...
function updateAvatar() {
    ...
    const url = `${baseURL}/${sprite}/svg?seed=${encodeURIComponent(playerName.value)}&backgroundColor=${color}`;
